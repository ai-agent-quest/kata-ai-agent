...
Ce projet contient de nombreux exercice utiles pour le développement d'agent IA basé sur `Python`.


## Exercices du dossier notebook

1 Interaction avec un llm
...
2- LLM augmenté
  ...
  6. [Utilisation de la mémoire](notebook/02-augmented-llm/06-memory.ipynb)
  7. [RAG](notebook/02-augmented-llm/07-rag.ipynb)
