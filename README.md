...
Ce projet contient de nombreux exercices utiles pour le développement d'agent IA basé sur `Python`. Nous vous recommandons d'ouvrir ce workspace avec vscode et d'installer les extensions vscode proposées à l'ouverture (python et jupyter, cela simplifie la modification et l'exécution).
...
## Installation
### Installation de UV (Python project Manager)
#### macOS et Linux
```bash
...
![alt text](assets/autonomous-agent.png)
